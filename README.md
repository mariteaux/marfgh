...
This is a repo for my working copy of marfGH. I build new features and test songs in a chart testing disc that acts as the template for the actual volume sets. Frozen-for-release scripts and menu milos can be found in their respective branches.
...
Songs, charts, and world milos are omitted from this repo, the former to avoid giving away customs before release, and the latter since they don't change per-disc.
...
- ~~**Shuffle Mode** - an option to play random songs in perpetuity (especially for Jukebox Mode)~~ This is implemented, but currently inaccessible.
